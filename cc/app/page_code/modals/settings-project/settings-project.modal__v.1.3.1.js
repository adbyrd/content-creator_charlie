 ...
 * EDIT:   All fields are pre-filled via hydration; the modal opens at
 *         projectDetails (step 1) so the user can review and advance normally.
 */
function initModal(project = null) {
    ...
    if (_isEditMode && project) {
        // ── EDIT MODE: update heading, hydrate all fields, open at step 1 ──
