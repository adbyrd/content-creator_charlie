 ...
 * Version: [Project Explorer: v1.1.2]
 */
...
$w.onReady(async function () {
    console.log('[Project Explorer: v1.1.2] Project Explorer Initialized');
    handleQueryStatus();
...
async function refreshProjectDashboard() {
    try {
        ...
        console.error('[Project Explorer: v1.1.2] Dashboard refresh failed:', err);
    }
}
...
async function openProjectSettings() {
    try {
        ...
        if (result && result.updated) {
            console.log('[Project Explorer: v1.1.2] New project created. Refreshing UI.');
            await refreshProjectDashboard();
            showToaster("Project created successfully!", "success");
        }
    } catch (err) {
        console.error('[Project Explorer: v1.1.2] Error opening project modal:', err);
    }
}